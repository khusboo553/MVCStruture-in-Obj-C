...
- (void)setupViews {
    ...
    detailsLabel.backgroundColor = clearColor;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _progressRemainingColor = clearColor;
        self.backgroundColor = clearColor;
        self.opaque = NO;
    }
    return self;
...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        if (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_7_0) {
            ...
            _color = [blackColor colorWithAlphaComponent:0.8];
        }
...
- (void)setDimBackground:(BOOL)dimBackground {
    ...
    self.backgroundView.color = dimBackground ? [UIColor colorWithWhite:0.f alpha:.2f] : clearColor;
}
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    self.backgroundColor = highlighted ? [baseColor colorWithAlphaComponent:0.1f] : clearColor;
}
