...
-(void)serviceHit{
    NSString *linkAddr=@"sort=&list=teams&access_token=a589847521cfb6420457b84d97addee8c7b108ad49d9a5768f66109bc0bbea21";
    ...
    [helperApi getHomeService:linkAddr andCallback:^(id jsonResponse){
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (jsonResponse!=nil) {
                ...
                [[singleToneClass sharedSingleTone] setDetailsDictionaryTeams:details];
                
                _tableViewCustom=[[UITableViewCustom alloc]initWithFrame:CGRectMake(0,0,SCREEN_WIDTH,_backgroundView.frame.size.height-10) withTableViewName:@"teamsTabCellId"];
                [_backgroundView addSubview:_tableViewCustom];
            }
        });
    }];
}
